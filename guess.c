...
Similarly if the user's guess is lower, it asks for a higher no until he guesses the no and finally
when the user guess the correct number the program displas the number of guesses user took to make the right guess*/
